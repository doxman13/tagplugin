          ...
          <td align="center" style="padding: 0px 40px 30px 30px;" valign="top">
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
              <tbody>
                ...
                <tr>
                  <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                    <p>Google テクニカルソリューションチームにご予約いただき誠にありがとうございます。Google 広告アカウント担当者より依頼を受け、<span data-infocase="customer_website" data-highlight="need_recheck">customer_website.com</span>のケース ID<span data-infocase="case_id" data-highlight="need_recheck">0-00000000000000</span>
                      についてサポートいたします。
  
                      &nbsp;</p>
                    <p dir="auto">Eメールで、本サポートのためのカレンダーの招待状をお送りしております。その指示に従い、出席をご確認ください。また事前準備として、&nbsp;<a href="https://support.google.com/google-ads/answer/11605860?hl=ja" target="_blank">こちらの To Do リスト</a>のチェックリストも完了しておいてください。</p>
                    <p dir="auto">お時間になりましたら、下記のリンクをクリックし、「参加をリクエスト」してください。（お時間になってもMeetに参加されないようであれば、お電話差し上げます。）</p>
                    <p dir="auto" data-highlight="need_recheck">
                      <a href="https://meet.google.com" data-infocase_link="customer_gmeet">ミーティングのリンク</a>
                    </p>
            ...
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
              <tbody>
                ...
                <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67);">
                  <p><span style="font-size:10px"><span style="font-family:Roboto,sans-serif"><span style="color:#000000"><span style="background-color:#ffffff"><em><strong>利用規約: </strong> お客様はこのメールに返信した時点で、ウェブサイト、キャンペーン、およびアナリティクス アカウントでの関連するコードのインストールを、必要に応じてテクニカル スペシャリストに委託することに同意したものと見なされます。お客様は、今後 Google が提案および導入する変更が、すべてお客様の意思と責任のもとで行われることを認識し、これに同意するものとします。Google では、変更により生じる影響についていかなる保証もいたしません。また、かかる変更によってどのような影響が生じた場合も Google は責任を負わないものとし、お客様がその全責任を負うものとします。こうした影響には Google 広告キャンペーンに関連する費用の増加が含まれますが、これに限定されません。また、ウェブサイトが引き続き意図したとおり機能することの検証はお客様が行うものとします。&nbsp;</em></span></span></span></span></p>
  
                  <p><span style="font-size:10px"><span style="font-family:Roboto,sans-serif"><span style="color:#000000"><span style="background-color:#ffffff"><em><strong>注意事項: </strong> 不測の事態に備え、設定変更が実施される前にウェブサイト全体のバックアップを取っておくことをおすすめします。サイトの認証情報については、Google の担当者をはじめ誰とも共有しないようにしてください。また、Google でお客様のリクエストを処理している最中に、お客様側でウェブサイトやアカウントに変更を加えられますと、変更や設定内容が一部失われる恐れがあります。ご依頼の変更作業が Google 側で完了するまで、ウェブサイトとアカウントには変更を加えないようお願いいたします。</em></span></span></span></span></p>
                      ...
                      <tbody>
                          <tr>
                              <td align="left"
                                  ...
                                  <span class="replaced">中村</span> 様
                              </td>
                          </tr>
                          <tr>
                              <td align="left"
                                  style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                  <strong><span class="replaced">analytics_troubleshooting</span></strong>
                          ...
                          <tr>
                              <td align="left"
                                  style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                  お客様のキャンペーンは、確認済みのインプレッションに基づいて想定どおりに機能しているため、ケース <span
                                      class="replaced">8-8227000033592</span> を終了いたしました。</td>
                          </tr>
                          <tr>
                              <td align="left"
                                  style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
...
<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
  <tbody>
    <tr>
      <td align="left" height="150" style="font-size: 28px; line-height: 36px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding: 30px 0px 30px 30px;" valign="middle" width="100%">お客様のケースの実装が正常に行われました</td>
      <td align="right" height="150" style="padding: 0 30px 0 10px;" valign="middle" width="130"><img alt="" border="0" src="https://storage.googleapis.com/fwm-emea-client-emails/google/14406_Gtech_Solutions/AS_Work_in_Progress_Offline_Support_ts_as_wip_offtfr.png" style="display: block;min-width:100px;" width="100"></td>
    </tr>
  </tbody>
</table>
      ...
      <td align="center" style="padding: 0px 40px 30px 30px;" valign="top">
        <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
          <tbody>
            ...
            <tr>
              <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                <strong><span class="replaced">Case Type</span></strong>
            ...
            <tr>
              <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                それまでの間、本リクエストを終了させていただきます。ご質問やご不明な点がございましたら、このメールへの返信にてお問い合わせいただくか、<a href="https://support.google.com/" style="color: rgb(26, 115, 232); text-decoration-line: none;" target="_BLANK" class="ignore-globals">Google ヘルプセンター</a>をご覧ください。</td>
            </tr>
            <tr>
              <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67);">
                今後ともよろしくお願いいたします。</td>
              ...
              <td>
                <div dir="ltr" align="left">
                  <table>
                    <tbody>
                      <tr>
                        <td colspan="2"> <span class="replaced" style="font-size:13px;" dir="auto" data-infosetting="your-name"> Name
                            <br>テクニカルソリューションチーム<br>TDCX（パートナー事業者）</span> </td>
                      </tr>
                    </tbody>
                  </table>
                        ...
                        <tbody>
                            <tr>
                                <td align="left"
                                    style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                    <span class="replaced" 
                                        data-infocase="customer_name"
                                        data-highlight="need_recheck">Name</span>様、
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                    <span data-infocase="customer_website"
    ...
    <div class="_emailtemp">
        ...
        <div class="_emailtemp-item" data-type="SO - Verification not needed">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%" dir="auto">
                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                        ${jp_list_emailtemplatecontent.so_verification_not_needed}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="UMM No Show Closing Email">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                        ${jp_list_emailtemplatecontent.umm_noshow}
                    </div>
                </div>
            </div>
        </div>
