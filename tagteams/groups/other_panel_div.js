// ._panel_btnshortcut {
    ...
    // tagteamext_demo-other_panel_div.js.php
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                ...
                                                <p dir="auto">Cuộc hẹn tiếp theo để hướng dẫn <span data-infocase="customer_gender">bạn</span> sẽ <b>vào lúc <span data-highlight="need_recheck">00 giờ chiều ngày 1/11/2023</span> theo giờ Việt Nam. </b>Rất mong sự có mặt của <span data-infocase="customer_gender">bạn</span> để hoàn thành quá trình cài đặt cho trường hợp này.</p>
                                                <p dir="auto">Xin cảm ơn!</p>
                                                <p dir="auto">Trân trọng!</p>
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left" style="font-size: 16px; line-height: 26px; font-family: Roboto, Arial, sans-serif; color: rgb(60, 64, 67); padding-bottom: 18px;">
                                                ...
                                                <ol>
                                                    <li dir="ltr" aria-level="1">Đăng nhập vào <a href="https://ads.google.com/intl/other_vn/home/" style="color: rgb(26, 115, 232); text-decoration-line: none;" class="ignore-globals">tài khoản Google Ads</a> của bạn.<br><br></li>
    ...
    <div class="_emailtemp">
        ...
        <div class="_emailtemp-item" data-type="UMM No Show Closing Email">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%" dir="auto">
                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                        ${other_list_emailtemplatecontent.umm_no_show}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="Hướng dẫn chèn mã GTM và xác nhận lịch hẹn">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%" dir="auto">
                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                        ${other_list_emailtemplatecontent.huong_dan_chen_ma_gtm_va_xac_nhan_lich_hen}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="AS - Reschedule 1">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width: 100%;">
                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                        ${other_list_emailtemplatecontent.as_reschedule_1}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="SO - Verified">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content" style="font:normal 13px/17px Roboto,sans-serif;display:block" dir="auto">
                        ${other_list_emailtemplatecontent.so_verified}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ni_attempted_contact}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="IN - Not Reachable">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.in_not_reachable}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="SO - Verification Not Needed">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.so_verification_not_needed}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="NI - Awaiting Validation">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ni_awaiting_validation}
                    </div>
                </div>
            </div>
        </div>
        <div class="_emailtemp-item" data-type="[EC] [A] If PII is Visible / Available  ">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_a_if_pii_is_visible_available}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="[EC] [B] (Automatic eligible) If PII is not Visible / Available  ">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_b_automatic_eligible_if_pii_is_not_visible_available}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="[EC] [C] (Automatic - Not eligible) If PII is not Visible / Available   ">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_c_automatic_not_eligible_if_pii_is_not_visible_available}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="[EC] [D] Ecommerce website Or Cases when you are unable to check PII ">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_d_ecommerce_website_or_cases_when_you_are_unable_to_check_pii}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="[EC] [E] If an advertiser is Eligible for the  Automatic Option (based on Pre-Call Checks) - Keep either GTM or gTag (one of the two options below) option based on Advertiser’s conversion set up [E-GTAG]">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_e_if_an_advertiser_is_eligible_for_the_automatic_option_based_on_pre_call_checks_keep_either_gtm_or_gtag_one_of_the_two_options_below_option_based_on_advertisers_conversion_set_up}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="[EC] [F] If Advertiser imports Google Analytics conversions for tracking and wants to implement EC">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_f_if_advertiser_imports_google_analytics_conversions_for_tracking_and_wants_to_implement_ec}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="_emailtemp-item" data-type="[EC] [G] If advertiser CMS is not supported for EC Implementation, send this email">
            ...
            <div class="_emailtemp-item__content">
                <div id="email-body-content-top" style="width:100%">
                    <div id="email-body-content-top-content">
                        ${other_list_emailtemplatecontent.ec_g_if_advertiser_cms_is_not_supported_for_ec_implementation_send_this_email}
                    </div>
                </div>
            </div>
        </div>
