...
var other_key_task_searchandreplace = `
...
var other_checkStyleByTheme = (opt_isdisable) => {
...
var other_clearAndPrepareCRTemplate = () => {
    // Prepare
            ...
            if(_email_body_content_top_content.innerText.trim().length > 0) {
                ...
                if(_tdcellist.length) {
                    _tdcellist.forEach((item) => {
                        ...
                        var _getvalue = searchAndReturnValue(other_heading_searchandreplace, _heading, 1);
                        if(_getvalue) {
                ...
                if(_tdcellist.length) {
                    _tdcellist.forEach((item) => {
                        var _heading = item.innerText.trim();
                        var _list = ['']
                        var _getvalue = searchAndReturnValue(other_key_task_searchandreplace, _heading, 1);
                        if(_getvalue) {
                            item.innerText = _getvalue;
                        }
                    })
                ...
                if(_tr.length) {
                    _tr.forEach((item) => {
                        ...
                        other_searchandremove.forEach((item2) => {
                            if(_text == item2) {
                                item.remove();
                            }
                        })
