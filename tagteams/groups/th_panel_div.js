...
var th_panel_div = `
    ...
    <div class="_panel minisize  _panel_emailtemplate">
        <div data-panel="email-template" class="active">
            <div class="_panel__heading">
                <div class="_panel__heading--group">
                    <span class="_panel__heading--close" data-btnaction="hide_panel-emailtemplate"><img src="${window.dataTagteam.assets_url_img}/315851/close.svg" alt="" srcset=""></span>
                    <img src="${window.dataTagteam.assets_url_img}/Google_2015_logo.svg" alt="" srcset="">
                    <span class="_panel__heading--title">Email Template</span>
                </div>
            </div>
